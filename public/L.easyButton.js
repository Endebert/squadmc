...
// then the usual `.addTo(map)`
  ...
  L.Control.EasyButton = L.Control.extend({
    ...
    _buildButton() {
      ...
      L.DomEvent.addListener(this.button, 'click', function (e) {
        L.DomEvent.stop(e);
        this._currentState.onClick(this, this.map ? this.map : null);
        this.map && this.map.getContainer().focus();
      }, this);
  ...
  L.easyButton = function (/* args will pass automatically */) {
    const args = Array.prototype.concat.apply([L.Control.EasyButton], arguments);
